...
(async () => {
    try {
        ...
        // Wait long enough for lockTimeouts to finish
        ...
        const hasInterval = await page.evaluate(() => typeof window.rollInterval !== 'undefined' ? (window.rollInterval ? "active" : "inactive") : "undefined");
        console.log("rollInterval status:", hasInterval);
