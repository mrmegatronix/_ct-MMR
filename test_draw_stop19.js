    ...
    try {
        ...
        await page.evaluate(() => {
             if (typeof window.stopLotteryRoll === 'function') {
                // REDEFINE temporarily in evaluate block to test without shadowing variables
                ...
                window.stopLotteryRoll = function(finalNumber, prizeType, speedParam) {
                    ...
                    // Clear EVERY interval from 0 to 9999 just to force it
                    ...
                    slots.forEach((slot, index) => {
                        ...
                        const t = setTimeout(() => {
                            ...
                            if (index === slots.length - 1) {
                                ...
                                slotsRolling = false;
                                rollingPrize = null;
                                console.log("Animation completed for index: " + index);
                            }
                        }, delay);
