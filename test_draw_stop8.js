...
(async () => {
    try {
        ...
        const lockTimeouts = await page.evaluate(() => typeof window.lockTimeouts !== 'undefined' ? window.lockTimeouts.length : 'undefined');
        console.log("lockTimeouts array length:", lockTimeouts);
